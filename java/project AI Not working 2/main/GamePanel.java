...
public class GamePanel extends JPanel implements Runnable{
    ...
    Map<Piece,Move> everyPieceMoves = new HashMap<>(); // piece and its last move
...
//        }
        ...
        ChessAI.findNextMove();
        System.out.println(ChessAI.targetMove.getCol() + " : " +  ChessAI.targetMove.getRow()); // endless loop after a few moves

        if (!moves.contains( ChessAI.targetMove)){
                moves.add(ChessAI.targetMove);
                System.out.println("adding   " + ChessAI.targetMove.getCol() + " : " +  ChessAI.targetMove.getRow()); // endless loop after a few moves
        ...
        System.out.println("stuck   " + ChessAI.targetMove.getCol() + " : " +  ChessAI.targetMove.getRow()); // endless loop after a few moves
        // check if the piece is hovering over a reachable square
        if (activeP.canMove(activeP.col,activeP.row))
        {
            System.out.println("generate the move:  " + activeP.col + ":" + activeP.row + " for: " + activeP.type);
            canMove = true;
            // if hitting a piece , remove it from the list
